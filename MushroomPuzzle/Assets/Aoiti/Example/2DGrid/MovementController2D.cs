...
public class MovementController2D : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        startRoots = FindObjectsOfType<StartRoots>();
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) //check for a new target
        {
            ...
            transform.position = Camera.main.ScreenToWorldPoint(startRoots[1].transform.position);
            GetMoveCommand(Camera.main.ScreenToWorldPoint(startRoots[0].transform.position));
        }
